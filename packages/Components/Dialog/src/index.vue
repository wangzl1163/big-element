<template>
   <el-dialog
      ...
      @closed="closed"
   >
      <template v-if="vueVersion.isVue2()" v-slot:title>
         <slot name="title"></slot>
      </template>

      <template v-if="vueVersion.isVue3()" v-slot:header>
      ...
      attrs() {
         if (vueVersion.isVue2()) {
            return {
               ...
               customClass: 'be-dialog ' + this.customClass
            }
         }
         ...
         if (vueVersion.isVue3()) {
            return {
               ...
               class: 'be-dialog ' + this.customClass
            }
         }
      },
      dialogWidth() {
